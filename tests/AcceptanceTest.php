...
class AcceptanceTest extends PHPUnit_Framework_TestCase
{
     ...
     * @test
     */
    public function shouldBeAbleToIdentifyAFourOfAKind()
    {
        $this->_givenTheseInputs("A-H  A-D  A-S  A-C  5-D  4-S  J-C")
            ->_theOutputShouldBe("A-S  A-H  A-C  A-D  J-C  (Four Of A Kind)");
    }
    ...
    {
        $this->_givenTheseInputs("7-D  10-H  10-C  A-S  10-D  5-D  7-C")
            ->_theOutputShouldBe("10-H  10-C  10-D  7-C  7-D  (Full House)");
    }
